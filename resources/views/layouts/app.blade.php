        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ URL::to('/') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Pixxie</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ in_array(Request::segment(1), ['dashboard'])?'active':''}}">
            ...
            <li class="menu-item {{ in_array(Request::segment(1), ['profile'])?'active':''}}">
              <a href="" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user"></i>
            ...
            @endif
              ...
              <li class="menu-item">
                <a href="" class="menu-link" target="_blank">
                  <i class="menu-icon tf-icons bx bxl-telegram" style="color: #229ED9;"></i>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <h4 class="fw-bold py-3 mt-3">
                    @if($page_parent_title)
                      <span class="text-muted fw-light"><a href="{{ $page_parent_url }}">{{ $page_parent_title }}</a>/</span> 
                    @endif
                    {{ $page_title }}
                  </h4>
                </div>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                @if(Auth::user()->type == 3)
                  <li class="nav-item lh-1 me-3">
                    ...
                    <span class="align-middle">Balance : @lang('messages.currencySign'){{ Auth::user()->user_balance }}</span>
                  </li>
                @endif
                <!-- User -->
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      @if(isset(Auth::user()->customer->avatar))
                        <img src="{{ URL::to('/').'/uploads/'.Auth::user()->customer->avatar }}" alt class="w-px-40 rounded-circle" />
                      @else
                        <img src="{{ URL::to('/') }}/assets/img/avatars/blankAvatar.jpg" alt class="w-px-40 h-auto rounded-circle" />
                      @endif
                    </div>
                  </a>
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">
                              ...
                              @elseif(Auth::user()->type == 2)
                                Admin
                              @else
                                Referral Code: {{ Auth::user()->customer->referral_code }}
                              @endif
                            </small>
                          </div>
                        </div>
