        ...
        <div class="col-lg-3 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              ...
              <span>$service_ticket->title</span>
          ...
          <div class="card">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between">
                <div class="avatar flex-shrink-0">
                  <img
                    src="{{ URL::to('/') }}/assets/img/icons/unicons/cc-warning.png"
                    alt="Credit Card"
                    class="rounded"
                  />
                </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between">
                <div class="avatar flex-shrink-0">
                  <img
                    src="{{ URL::to('/') }}/assets/img/icons/unicons/wallet.png"
                    alt="Credit Card"
                    class="rounded"
                  />
                </div>
              ...
              <h3 class="card-title text-nowrap mb-1"> @lang('messages.currencyExchangeSign')</h3>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-12 col-6 mb-4">
          <div class="card">
            <div class="card-body">
              <div class="card-title d-flex align-items-start justify-content-between">
                <div class="avatar flex-shrink-0">
                  <img
                    src="{{ URL::to('/') }}/assets/img/icons/unicons/wallet-info.png"
                    alt="Credit Card"
                    class="rounded"
                  />
                </div>
