  ...
  <div class="card-body">
    ...
    <div class="app-brand justify-content-center">
      <a href="{{ URL::to('/') }}" class="app-brand-link gap-2">
        ...
        <span class="app-brand-text demo text-body fw-bolder">Pixxie</span>
      </a>
    </div>
    <!-- /Logo -->
    <h4 class="mb-2">Adventure starts here 🚀</h4>
    <p class="mb-4">Make your earnings easy and fun!</p>
    @if ($errors->has('errMsg'))
      <div class="alert alert-danger">{{ $errors->first('errMsg') }}</div>
    @endif
